...
import { Accordion, AccordionDetails, AccordionSummary, Box, Pagination, PaginationItem, Stack, Table, TableBody, TableCell, TableHead, TableRow } from "@mui/material";
            ...
            <Box className="processing_body">
                ...
                >
                    ...
                    <Stack
                        ...
                        gap={"30px"}
                    >
                        <Box className="delivery_details">
                        ...
                        <Box className="w-50">
                            <Box className={"processed_products"}>
                                {
                            ...
                            <Stack className="fs-4" direction={"row"} justifyContent={"space-between"}>
                                <div>Subtotal</div>
                                <div>$999.00</div>
                            </Stack>
                            <Stack className="fs-2" direction={"row"} justifyContent={"space-between"}>
                                <div>Total</div>
                                <div>$999.00</div>
                            </Stack>
